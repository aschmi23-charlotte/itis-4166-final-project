...
router.post('/', permissionHandler.authenticate, toDoListValidator.validateCreate, permissionHandler.authorizeAccessRules("role:ADMIN", "newlist:owner_is_user"), listController.create);
...
router.delete(":list_id", permissionHandler.authenticate, listController.delete);
